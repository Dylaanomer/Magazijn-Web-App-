...
{
    public partial class FORFUCKSSAKE : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SearchString5 = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    SearchString6 = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    SearchString7 = table.Column<string>(type: "nvarchar(max)", nullable: true),
